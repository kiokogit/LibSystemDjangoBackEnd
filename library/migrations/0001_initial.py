# Generated by Django 3.2.7 on 2022-02-10 02:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('noOfPages', models.CharField(blank=True, max_length=200, null=True)),
                ...
                ('RFIDtag', models.CharField(blank=True, max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dateReturned', models.DateTimeField(blank=True, null=True)),
                ('finesAccumulated', models.CharField(default=0, max_length=10)),
                ('book', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='library.requestedbooks')),
            ],
        ),
        migrations.CreateModel(
            name='BooksInCart',
